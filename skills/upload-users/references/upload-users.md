...
|---|---|---|---|
| `POST` | `/api/public/v1/user/import-csv` | Gateway | `200` |
...
|---|---|:---:|:---:|---|
| `body: file` | `string (binary)` | No | No | — |

Body media type: `multipart/form-data`.
...
curl --fail-with-body --silent --show-error \
  ...
  --form 'file=@users.csv;type=text/csv' \
  "https://iterogatewayapi.azurewebsites.net/api/public/v1/user/import-csv"
```
